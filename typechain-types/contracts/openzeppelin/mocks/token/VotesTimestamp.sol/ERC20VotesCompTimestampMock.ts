...
export interface ERC20VotesCompTimestampMockInterface extends utils.Interface {
  functions: {
...
export interface ERC20VotesCompTimestampMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20VotesCompTimestampMockInterface;
