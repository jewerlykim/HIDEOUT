...
export interface ERC721VotesTimestampMockInterface extends utils.Interface {
  functions: {
...
export interface ERC721VotesTimestampMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721VotesTimestampMockInterface;
