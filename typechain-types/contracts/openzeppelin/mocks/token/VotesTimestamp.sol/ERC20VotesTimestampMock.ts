...
export interface ERC20VotesTimestampMockInterface extends utils.Interface {
  functions: {
...
export interface ERC20VotesTimestampMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20VotesTimestampMockInterface;
