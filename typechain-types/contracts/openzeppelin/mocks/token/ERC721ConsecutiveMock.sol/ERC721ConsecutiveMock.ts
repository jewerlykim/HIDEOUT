...
export interface ERC721ConsecutiveMockInterface extends utils.Interface {
  functions: {
...
export interface ERC721ConsecutiveMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721ConsecutiveMockInterface;
