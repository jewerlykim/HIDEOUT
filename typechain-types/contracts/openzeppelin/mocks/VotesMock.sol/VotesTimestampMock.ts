...
export interface VotesTimestampMockInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "delegate(address,address)",
...
export interface VotesTimestampMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VotesTimestampMockInterface;
  ...
  functions: {
    ...
    "delegate(address,address)"(
      ...
      newDelegation: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
