...
export interface GovernorPreventLateQuorumMockInterface
...
export interface GovernorPreventLateQuorumMock extends BaseContract {
  ...
  functions: {
    ...
    setLateQuorumVoteExtension(
      newVoteExtension: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
