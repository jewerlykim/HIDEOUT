...
export interface GovernorWithParamsMockInterface extends utils.Interface {
  functions: {
...
export interface CountParamsEventObject {
  uintParam: BigNumber;
  strParam: string;
}
export type CountParamsEvent = TypedEvent<
  [BigNumber, string],
  CountParamsEventObject
>;

export type CountParamsEventFilter = TypedEventFilter<CountParamsEvent>;
...
export interface GovernorWithParamsMock extends BaseContract {
  ...
  filters: {
    "CountParams(uint256,string)"(
      uintParam?: null,
      strParam?: null
    ): CountParamsEventFilter;
    CountParams(uintParam?: null, strParam?: null): CountParamsEventFilter;
