...
export interface ERC721ATransferCounterMockInterface extends utils.Interface {
  functions: {
    ...
    "directApprove(address,uint256)": FunctionFragment;
    ...
    "setExtraDataAt(uint256,uint24)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "directApprove",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setExtraDataAt",
...
export interface ERC721ATransferCounterMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721ATransferCounterMockInterface;
